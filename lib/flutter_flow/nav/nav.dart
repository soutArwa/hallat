...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'signup-in',
          path: '/signupIn',
          builder: (context, params) => SignupInWidget(
            selectedTabIndex: params.getParam(
              'selectedTabIndex',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: 'Frogetpassword',
          path: '/frogetpassword',
          builder: (context, params) => FrogetpasswordWidget(
            selectedTabIndex: params.getParam(
              'selectedTabIndex',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'Alldone',
          path: '/alldone',
          builder: (context, params) => AlldoneWidget(
            selectedTabIndex: params.getParam(
              'selectedTabIndex',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'accommodation',
          path: '/accommodation',
          builder: (context, params) => AccommodationWidget(),
        ),
        FFRoute(
          name: 'googleMap',
          path: '/googleMap',
        ...
        FFRoute(
          name: 'detailedDestination',
          path: '/detailedDestination',
          builder: (context, params) => DetailedDestinationWidget(),
        ),
        FFRoute(
          name: 'transportation',
          path: '/transportation',
        ...
        FFRoute(
          name: 'itinirary',
          path: '/itinirary',
          builder: (context, params) => ItiniraryWidget(),
        ),
        FFRoute(
          name: 'Settings',
          path: '/settings',
