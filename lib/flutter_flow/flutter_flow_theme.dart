...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF588157);
  ...
  late Color accent1 = const Color(0x4F588157);
  ...
  late Color success = const Color(0xFF3A5A40);
  late Color warning = const Color(0xFFF3C344);
  late Color error = const Color(0xFFC4454D);
  late Color info = const Color(0xFFFFFFFF);

  late Color timberwolf = Color(0xFFDAD7CD);
  late Color sage = Color(0xFFA3B18A);
  late Color fernGreen = Color(0xFF588157);
  late Color hunterGreen = Color(0xFF3A5A40);
  late Color brunswickGreen = Color(0xFF344E41);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8EAA8C);
  late Color secondary = const Color(0xFF928163);
  late Color tertiary = const Color(0xFF6D604A);
